...
public:
    ...
    static void printsalary(int empid)
    {
        fstream rd;
        rd.open("salary.txt",std::ios::in);
        if(!rd)
        {
        ...
        int found=0;
        while(rd.read(reinterpret_cast<char*>(&empobj),sizeof(empobj)))
        {
            if(empobj.empid==empid)
            {
                empobj.show_data();
...
void name()
{
    ...
    int found = 0;
    while (rd.read((char *)&empobj, sizeof(empobj)))
    {
        if (strcmp(empobj.ename, searchName.c_str()) == 0)
        {
            cout << endl << "-----------------------------------------------Employee details-------------------------------------";
            empobj.show_data();
            found = 1;
...
int main()
{
    while(1)
    {
        cout<<endl<<"*Employee Management and Salary Disbursement System";
        cout<<endl<<"------------------------------------------------------------------------";
        ...
        cout<<endl<<"press 7 to input empid and get disburse salary";
        cout<<endl<<"press 8 to search by name";
        cout<<endl<<"press 9 to Exit";
        cout<<endl<<"----------------------------------------------------------------------------";
        cout<<endl<<"Please Enter the Select Number:---";
        int choice;
        cin>>choice;
        if(choice==1)
        {
